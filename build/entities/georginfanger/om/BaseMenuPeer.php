...
abstract class BaseMenuPeer
{
    ...
    const DATABASE_NAME = 'georginfanger';
    ...
    /** the column name for the pk_menu field */
    const PK_MENU = 'menu.pk_menu';

    /** the column name for the menu_name_de field */
    const MENU_NAME_DE = 'menu.menu_name_de';

    /** the column name for the menu_name_en field */
    const MENU_NAME_EN = 'menu.menu_name_en';

    /** the column name for the menu_link field */
    const MENU_LINK = 'menu.menu_link';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('PkMenu', 'MenuNameDe', 'MenuNameEn', 'MenuLink', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('pkMenu', 'menuNameDe', 'menuNameEn', 'menuLink', ),
        BasePeer::TYPE_COLNAME => array (MenuPeer::PK_MENU, MenuPeer::MENU_NAME_DE, MenuPeer::MENU_NAME_EN, MenuPeer::MENU_LINK, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PK_MENU', 'MENU_NAME_DE', 'MENU_NAME_EN', 'MENU_LINK', ),
        BasePeer::TYPE_FIELDNAME => array ('pk_menu', 'menu_name_de', 'menu_name_en', 'menu_link', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('PkMenu' => 0, 'MenuNameDe' => 1, 'MenuNameEn' => 2, 'MenuLink' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('pkMenu' => 0, 'menuNameDe' => 1, 'menuNameEn' => 2, 'menuLink' => 3, ),
        BasePeer::TYPE_COLNAME => array (MenuPeer::PK_MENU => 0, MenuPeer::MENU_NAME_DE => 1, MenuPeer::MENU_NAME_EN => 2, MenuPeer::MENU_LINK => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PK_MENU' => 0, 'MENU_NAME_DE' => 1, 'MENU_NAME_EN' => 2, 'MENU_LINK' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('pk_menu' => 0, 'menu_name_de' => 1, 'menu_name_en' => 2, 'menu_link' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MenuPeer::PK_MENU);
            $criteria->addSelectColumn(MenuPeer::MENU_NAME_DE);
            $criteria->addSelectColumn(MenuPeer::MENU_NAME_EN);
            $criteria->addSelectColumn(MenuPeer::MENU_LINK);
        } else {
            $criteria->addSelectColumn($alias . '.pk_menu');
            $criteria->addSelectColumn($alias . '.menu_name_de');
            $criteria->addSelectColumn($alias . '.menu_name_en');
            $criteria->addSelectColumn($alias . '.menu_link');
        }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(MenuPeer::PK_MENU);
            $value = $criteria->remove(MenuPeer::PK_MENU);
            if ($value) {
                $selectCriteria->add(MenuPeer::PK_MENU, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MenuPeer::PK_MENU, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(MenuPeer::DATABASE_NAME);
        $criteria->add(MenuPeer::PK_MENU, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(MenuPeer::DATABASE_NAME);
            $criteria->add(MenuPeer::PK_MENU, $pks, Criteria::IN);
