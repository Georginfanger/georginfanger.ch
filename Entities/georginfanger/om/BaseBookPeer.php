...
abstract class BaseBookPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Author', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'author', ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID, BookPeer::AUTHOR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'AUTHOR', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'author', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Author' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'author' => 1, ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID => 0, BookPeer::AUTHOR => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'AUTHOR' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'author' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
